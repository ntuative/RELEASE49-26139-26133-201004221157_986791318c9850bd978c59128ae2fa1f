package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1259:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_989:String = "group_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1259:
               if(var_156 != null)
               {
                  _loc5_ = var_156.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_989:
               if(var_156 != null)
               {
                  if(var_156 != null)
                  {
                     _loc5_ = var_156.getKey("group.badge.url");
