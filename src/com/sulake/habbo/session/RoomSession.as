package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1004:UserDataManager;
      ...
      {
         if(var_32 == RoomSessionEvent.const_305 && _connection != null)
         {
            var_32 = RoomSessionEvent.const_98;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1004 as IUserDataManager;
      }
