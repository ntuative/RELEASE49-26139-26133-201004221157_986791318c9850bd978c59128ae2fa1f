package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_797:int = 100;
       
      
      private var var_2229:IScrollbarWindow;
      
      private var var_120:HabboMessenger;
      
      private var var_1594:IContainerButtonWindow;
      
      private var var_535:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_120 = param1;
         var_1594 = initButton("follow_friend",onFollowButtonClick,param2);
         var_49 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2229 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_120.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_120.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_614 || param3.type == Message.const_578 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_535.messages.length - const_797);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_535.messages.length)
         {
            refreshEntry(true,_loc1_,var_535.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc1_:Conversation = var_120.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(var_535 == null || _loc1_.id != var_535.id)
         {
            var_535 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_797 + const_1120)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_120.conversations.closeConversation();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_120.send(new FollowFriendMessageComposer(var_535.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_120.getButtonImage(param1);
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_120.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_120.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
