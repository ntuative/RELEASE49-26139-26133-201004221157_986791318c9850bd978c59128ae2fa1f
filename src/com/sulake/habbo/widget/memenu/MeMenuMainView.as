      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_803));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_650);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_908));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_285);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_871));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_543);
               break;
            case "news":
               if(false && false)
               {
