   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_902 = _window.findChildByName("effect_hilite");
            var_902.visible = false;
         }
         var_903 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_901 = _window.findChildByName("loader_bar");
         if(var_901 != null)
         {
            var_402 = var_901.width;
            var_182.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_903 != null)
         {
            var_903.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_903.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
