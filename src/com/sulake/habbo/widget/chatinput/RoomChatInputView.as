package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_503:int = 16;
      
      private static const const_1061:int = 20;
      ...
      private var var_402:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1007 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1895 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1896 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_689 = new Timer(1000,1);
         var_689.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_825 = new Timer(5000,1);
         var_825.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_125,onInputChanged);
         _window.addEventListener(WindowEvent.const_437,onWindowMoved);
         var_1207 = true;
         var_131 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1894 = _loc2_.width + const_503 + _loc6_.width + const_1061;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1062,_loc8_.width) + const_503);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1007 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_131 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_402);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_402);
         }
