package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_450:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_450 = new Sprite();
            var_450.addChild(new Bitmap(_image));
            var_450.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_450.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_450);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1602 != "")
         {
            HabboWebTools.openWebPage(var_1602);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_450 != null)
         {
            var_450.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_450 = null;
         }
         if(_image != null)
         {
