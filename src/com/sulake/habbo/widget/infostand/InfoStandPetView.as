package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1642:String = "level";
      
      private var var_104:IItemListWindow;
      
      private const const_1643:String = "energy";
      ...
      private const const_1641:uint = 3355443;
      
      private var var_243:IBorderWindow;
      
      private const const_1636:int = 158;
      
      private const const_1640:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_167:PetCommandTool;
      
      private const const_1644:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_243 != null)
         {
            var_104 = var_243.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_104 == null || var_243 == null || var_61 == null)
         {
            return;
         }
         ...
         var_243.height = NaN;
         _window.width = Math.max(var_243.width,var_61.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1152.getValue(var_574) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1642,param1.level,param1.levelMax);
         updateStateElement(const_1637,param1.experience,param1.experienceMax);
         updateStateElement(const_1643,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_574 = param1.id;
         var_1152.remove(param1.id);
         var_1152.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_167 && var_167.getPetId() == var_574)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_441,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1636,const_1640,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1644);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1641);
