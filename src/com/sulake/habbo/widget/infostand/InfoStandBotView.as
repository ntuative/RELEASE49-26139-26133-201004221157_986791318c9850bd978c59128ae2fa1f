package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandBotView extends InfoStandUserView
   {
      ...
      override protected function method_5(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
      ...
      override protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_.name == "kick")
         {
            ...
            _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_429,_loc3_));
         }
      }
   }
}
