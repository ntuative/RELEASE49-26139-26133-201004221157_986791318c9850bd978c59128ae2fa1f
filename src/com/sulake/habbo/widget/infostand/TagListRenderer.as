package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      {
         var _loc2_:* = null;
         if(var_1329 != null && var_1329.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_110);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_800 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_800 += param1.height + const_1635;
            return fit(param1);
         }
         param1.offset(_offsetX,var_800);
         _offsetX += param1.width + const_1634;
         return true;
      }
