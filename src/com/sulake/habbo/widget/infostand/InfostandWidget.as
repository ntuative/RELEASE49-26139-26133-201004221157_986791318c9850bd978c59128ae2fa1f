package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1413:String = "infostand_user_view";
      
      private var var_293:InfoStandPetView;
      
      private var var_1152:InfoStandPetData;
      
      private var var_122:Timer;
      
      private var var_787:InfoStandFurniView;
      
      private var var_392:InfostandFurniData;
      ...
      private const const_1412:String = "infostand_pet_view";
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_787 = new InfoStandFurniView(this,const_1411);
         var_187 = new InfoStandUserView(this,const_1413);
         var_293 = new InfoStandPetView(this,const_1412);
         var_333 = new InfoStandBotView(this,const_1410);
         var_399 = new InfostandUserData();
         var_392 = new InfostandFurniData();
         var_1152 = new InfoStandPetData();
         var_122 = new Timer(const_1632);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_187.setTags(param1.tags,var_1642);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_224,onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_267,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_123,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_554,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_625,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_378,var_293.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_224,onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_267,onRoomObjectRemoved);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_123,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_554,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_625,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_267:
               ...
               {
                  _loc2_ = param1.id == var_1152.roomIndex;
                  break;
               }
