package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_238.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_238.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_60,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1050,const_1049,2,2),null,0) as IWindowContainer;
         ...
         var_238 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_238.numTabItems)
         {
            _loc6_ = var_238.getTabItemAt(_loc2_);
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_238.selector.getSelected();
         return var_238.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_987 = _loc2_.light;
         if(var_337 != null)
         {
            var_337.setValue(var_987);
         }
         var_448 = colors.indexOf(_loc2_.color);
         if(var_486 != null)
         {
            var_486.setSelectedColorIndex(var_448);
         }
