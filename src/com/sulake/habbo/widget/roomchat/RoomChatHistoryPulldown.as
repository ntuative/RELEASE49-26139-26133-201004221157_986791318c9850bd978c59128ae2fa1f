package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_788:int = 150;
      
      private static const const_789:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_36 = param3;
         var_2082 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1537 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_2083 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1536 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1535 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_2078 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_2081 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_71 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_43,HabboWindowParam.const_72,new Rectangle(0,0,param3.width,param3.height - const_77),null,0,0) as IBitmapWrapperWindow;
         var_36.addChild(var_71);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_60,HabboWindowStyle.const_43,HabboWindowParam.const_44,new Rectangle(0,0 - const_77,param3.width,const_77),null,0) as IWindowContainer;
         var_36.addChild(_window);
         var_96 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_412,HabboWindowStyle.const_42,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_77),null,0) as IRegionWindow;
         if(var_96 != null)
         {
            var_96.background = true;
            var_96.mouseTreshold = 0;
            var_96.addEventListener(WindowMouseEvent.const_52,onPulldownMouseDown);
            var_36.addChild(var_96);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_401:
               var_71.blend += param1 / const_789;
               _window.blend += param1 / const_789;
               if(false)
               {
                  state = const_329;
               }
               break;
            case const_781:
               var_71.blend = 0 - param1 / const_788;
               _window.blend = 0 - param1 / const_788;
               if(true)
               {
                  state = const_214;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_96 != null)
         {
            var_96.x = 0;
            var_96.y = 0 - const_77;
            var_96.width = 0 - var_2079;
         }
         if(var_71 != null)
         {
            var_71.rectangle = var_36.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_2080 == _window.width)
         {
            return;
         }
         var_2080 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_2082.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1537.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1537.clone(),_loc9_);
