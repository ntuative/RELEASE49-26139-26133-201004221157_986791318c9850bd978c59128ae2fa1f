package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_503:int = 6;
      
      private static const const_355:int = 10;
      
      private static const const_1117:Number = 18;
      
      private static const const_1435:Number = 10;
      
      private static const const_1436:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1091,var_1092,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1091,var_760,var_1092,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1350 = param1.chatType;
         var_1091 = param1.userId;
         var_760 = param1.userName;
         var_1092 = param1.userCategory;
         _message = param1.text;
         var_1348 = param1.userX;
         var_208 = param1.userImage;
         var_1093 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1350)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_108:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_279:
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1093 != 0)
            {
               _loc30_ = uint(var_1093 >> 16 & 255);
               _loc31_ = uint(var_1093 >> 8 & 255);
               _loc32_ = uint(var_1093 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1350 == RoomWidgetChatUpdateEvent.const_279)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_760);
            }
            else if(var_1350 == RoomWidgetChatUpdateEvent.const_272)
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_446;
            _loc20_.width = _loc20_.textWidth + const_503;
            _width += _loc20_.textWidth + const_503;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_355 + _loc20_.textWidth + const_503;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1091,var_1092,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1091,var_1092,_roomId,_roomCategory,param1);
      }
