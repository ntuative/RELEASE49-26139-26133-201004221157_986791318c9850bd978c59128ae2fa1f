package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_884:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_410,0,0,_loc4_,var_1544,var_885,var_884));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2116 = int(_config.getKey("interstitial.interval","30000"));
         var_2115 = int(_config.getKey("interstitial.show.time","5000"));
         var_1545 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1305 = _loc2_.imageUrl;
         var_1544 = _loc2_.clickUrl;
         if(var_1305 != "" && var_1544 != "")
         {
            _loc3_ = var_1305;
            ...
            _loc4_ = new URLRequest(var_1305);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1304 = _loc2_.imageUrl;
         var_2117 = _loc2_.clickUrl;
         var_732 = getTimer();
         if(var_1304 != "")
         {
            _loc3_ = var_1304;
            ...
            var_237.start();
            _loc4_ = new URLRequest(var_1304);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_395,0,0,param1.bitmapData,var_2117));
            var_732 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_884 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1545 > 0 && var_1543 >= var_1545)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_732;
         if(_loc1_ > var_2116)
         {
            ++var_1543;
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_885 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
