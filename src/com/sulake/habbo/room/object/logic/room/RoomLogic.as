package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1509:int = 1500;
      
      private var var_1507:int = 255;
      
      private var var_1508:int = 255;
      
      private var var_1265:uint = 16777215;
      
      private var var_1039:uint = 16777215;
      
      protected var var_75:RoomPlaneParser = null;
      
      private var var_855:int = 0;
      
      private var var_1170:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               ...
               case RoomObjectRoomUpdateMessage.const_616:
                  _loc2_.setString(RoomObjectVariableEnum.const_681,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_631:
                  _loc2_.setString(RoomObjectVariableEnum.const_642,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_465:
                  ...
                  var_388.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_546:
                  _loc7_ = var_388.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_388.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_937,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1020,int(_loc5_.bgOnly));
            var_1265 = _color;
            var_1507 = var_1170;
            var_1039 = _loc11_;
            var_1508 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_905,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_636,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1380,_loc20_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_143 || _loc13_ == RoomPlaneData.const_266)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_855)
         {
            ...
            {
               _loc7_ = var_1265 >> 16 & 255;
               _loc8_ = var_1265 >> 8 & 255;
               _loc9_ = var_1265 & 255;
               _loc10_ = var_1039 >> 16 & 255;
               _loc11_ = var_1039 >> 8 & 255;
               _loc12_ = var_1039 & 255;
               _loc13_ = (_loc2_ - var_855) / var_1509;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1507 + (var_1508 - var_1507) * _loc13_;
               _color = _loc3_;
               var_1170 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_636,_loc3_);
         }
      }
   }
}
