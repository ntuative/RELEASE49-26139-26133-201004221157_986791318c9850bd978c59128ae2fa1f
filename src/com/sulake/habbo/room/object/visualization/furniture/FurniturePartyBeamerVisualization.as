package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_777:int = 15;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1024[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1023[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1024 = new Array();
         var_1024.push(Math.random() * _loc2_ * 1.5);
         var_1024.push(Math.random() * _loc2_ * 1.5);
         var_1026 = new Array();
         var_1026.push(1);
         var_1026.push(-1);
         var_1025 = new Array();
         var_1025.push(const_1069);
         var_1025.push(const_1068);
         var_1023 = new Array();
         var_1023.push(getRandomAmplitudeFactor());
         var_1023.push(getRandomAmplitudeFactor());
      }
