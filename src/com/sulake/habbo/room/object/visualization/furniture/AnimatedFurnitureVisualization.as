package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_480 == 0)
         {
            var_480 = _animationData.getStartFrame(var_978,param1);
         }
         var_480 += 1;
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_924)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_978,var_480,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_978,_loc6_,_loc5_.activeSequenceOffset + 1,var_480,param1);
               }
