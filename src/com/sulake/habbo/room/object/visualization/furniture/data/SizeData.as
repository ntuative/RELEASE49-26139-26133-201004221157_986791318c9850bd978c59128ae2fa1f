package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1136:int = 360;
      
      private var var_1649:int = 0;
      
      private var var_658:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1136 / 2) % 360 / var_1136;
         ...
         {
            _loc6_ = int(var_217.getKey(_loc5_)) * var_1136;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_801);
                  break;
               case "SUBTRACT":
