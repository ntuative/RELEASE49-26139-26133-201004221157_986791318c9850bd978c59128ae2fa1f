package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1084:Number = 30;
      ...
      {
         var _loc3_:Number = var_1125 * Math.cos(var_864 + var_1516);
         var _loc4_:Number = var_1125 * Math.sin(var_864 + var_1516);
         var _loc5_:Number = _height;
         var_724.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_724.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_724.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_724.add(param1);
         }
