package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_337);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_381);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_658);
