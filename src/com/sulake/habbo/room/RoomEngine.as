package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_497:String = "room";
      ...
      private var var_250:IAdManager = null;
      
      private var var_573:NumberBank;
      ...
      private var var_693:RoomMessageHandler = null;
      
      private var var_692:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_298 = new Map();
         var_573 = new NumberBank(1000);
         var_1009 = new Map();
         var_297 = new Map();
         var_65 = new RoomObjectEventHandler(this);
         var_693 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_65 != null)
         {
            ...
            {
               return var_65.deleteWallItem(var_112,var_113,param1);
            }
         }
         return false;
      }
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           ...
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_661) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_611) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_517) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_65.modifyWallItemData(var_112,var_113,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_692 != null)
         {
            var_692.release(new IIDRoomRendererFactory());
            var_692 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_733);
         }
         if(_loc10_.geometry != null)
         {
            ...
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_812);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_977) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_830);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_726,var_112,var_113,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            return var_65.modifyRoomObject(var_112,var_113,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_616,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_40 != null)
         {
            ...
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_70);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_65 != null)
         {
            var_65.handleRoomObjectEvent(param1,var_112,var_113);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_993,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1023,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_825,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_257,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      {
         if(var_27 == null || var_395 == null || var_40 == null || var_692 == null || _communication == null || _habboConfiguration == null || !var_1902)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_282,RoomObjectCategoryEnum.const_70);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1218,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_40.getRoom(getRoomIdentifier(var_112,var_113));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_113,var_1214);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_113,var_1214);
         if(_loc1_ != null)
         {
      ...
      private function initializeObjectEvents() : void
      {
         if(var_27 != null)
         {
            if(false)
            {
               var_27.events.addEventListener(RoomObjectMouseEvent.const_231,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_422,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_240,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_735,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_113,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_486,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_400,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_397,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_424,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_408,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_481,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_454,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_447,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectMoveEvent.const_458,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_474,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_265,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_425,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_293,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_289,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_399,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_976,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_404,roomObjectEventHandler);
               var_27.events.addEventListener(AvatarWalkWarpingWarningEvent.const_371,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_112,var_113);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_515) != 0)
         {
            return false;
         }
         if(var_65 != null)
         {
            return var_65.initializeRoomObjectInsert(var_112,var_113,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_257,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_682)
         {
            var_1902 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_257,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_250.events.addEventListener(AdEvent.const_410,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_690,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_692 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_40.getRoom(const_496);
         if(_loc10_ == null)
         {
            _loc10_ = var_40.createRoom(const_496,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_573.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_365,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
            ...
            case RoomObjectCategoryEnum.const_70:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_669,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_681,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_642,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
         ...
         if(!isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_827,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_573.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_775,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_113,param1);
         if(_loc9_ != null)
         {
            var_1214 = param1;
            var_1461 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1461 - _loc12_.width / 2;
               _loc11_.y = var_1462 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_438,var_112,var_113,-1,RoomObjectCategoryEnum.const_220));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_282,const_497);
                  var_65.handleRoomObjectEvent(_loc14_,var_112,var_113);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_112,var_113,param1,param2,new Vector3d(),1,null);
         }
         else if(var_12 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_113,var_1214);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1461 - _loc6_.data.width / 2;
               _loc11_.y = var_1462 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_288,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_822,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_949,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_893,RoomObjectVariableEnum.const_288,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_682,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_65 != null)
         {
            var_65.cancelRoomObjectInsert(var_112,var_113);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_40.getRoom(const_496);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_827);
      ...
      {
         return getRoomObjectBoundingRectangle(var_112,var_113,const_282,RoomObjectCategoryEnum.const_70,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_943,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_515,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_852,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_282,const_497,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_515,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_733,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_661,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_517,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_817,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_616,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_465,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_197);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        ...
                        _loc7_.setNumber(RoomObjectVariableEnum.const_812,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_775,const_1063,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_773,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
