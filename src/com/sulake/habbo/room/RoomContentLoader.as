package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      public static const const_682:String = "RCL_LOADER_READY";
      ...
      private var var_1043:IEventDispatcher = null;
      
      private var var_1270:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_514 = [];
         var_513 = [];
         var_2024 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2029 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_423 = new Map();
         _events = new Map();
      ...
      {
         if(var_176 != null && var_176.hasWorldType(const_283 + param1))
         {
            return var_176.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_423 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_423.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_423.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_423.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_352,const_501,ROOM_CONTENT,const_787,const_785];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2024.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_169 && _loc5_ != RoomObjectLogicEnum.const_111)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1197);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_435,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_2023)
         {
            ...
            if(var_1043 != null)
            {
               var_1043.dispatchEvent(new Event(const_682));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_176 != null)
         {
            return var_176.getWorldHeightScale(const_283 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1043 = param1;
            var_2025 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2026 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2028 = param2.getKey("public.room.dynamic.download.url","");
            var_2027 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_32 = const_786;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_424 != null)
         {
            var_424.remove(param2);
            var_424.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_169 && _loc5_ != RoomObjectVisualizationEnum.const_111)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_283 + param1) == RoomObjectCategoryEnum.const_70)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1270.getValue(param1) != null)
         {
            var_176 = var_1270.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_472,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_176 != null)
         {
            return var_176.getWorldScale(const_283 + param1);
         }
         return 32;
      }
