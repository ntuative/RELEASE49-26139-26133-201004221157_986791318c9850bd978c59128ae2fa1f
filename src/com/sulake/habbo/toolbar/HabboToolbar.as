package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_899,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_362,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_739,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_919,onHideWindowEvent);
         var_32 = true;
