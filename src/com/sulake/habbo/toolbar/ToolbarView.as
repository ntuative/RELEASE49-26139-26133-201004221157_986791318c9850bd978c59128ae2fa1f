package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_196 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_60,HabboWindowStyle.const_888,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1041 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1041)
         {
         ...
         var_1266 = _loc7_.toolbar.@margin_bottom;
         var_1511 = _loc7_.toolbar.@min_group_margin;
         var_1510 = _loc7_.toolbar.@margin_to_extrabar;
         var_264 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_277,param1,param2,_window,var_264);
         createGroupsFromXmlList(_loc9_,var_590,param1,param2,var_196,var_264);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_136,var_510,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1511,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1266) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1511,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1266) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_136,var_510);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_510);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_136,var_510);
         }
      }
