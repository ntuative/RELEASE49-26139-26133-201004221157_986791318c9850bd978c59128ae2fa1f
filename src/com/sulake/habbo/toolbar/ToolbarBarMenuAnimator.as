package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private var var_1098:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1098 = param2;
         var_633 = new Timer(const_1044);
         var_633.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_537.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_537.splice(_loc3_,1);
            var_536.splice(_loc3_,1);
         }
         var_536.push(param1.name);
         var_537.push(param2);
         param1.addEventListener(WindowEvent.const_437,windowEventListener);
         param1.addEventListener(WindowEvent.const_223,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_537[var_536.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1098.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_324.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_324.splice(var_324.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1098.getIconLoc(param1.iconId);
      ...
      {
         return var_536[var_537.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_324[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_632[_loc3_] = new Array();
            }
            if(var_632[_loc3_].indexOf(param1) < 0)
            {
               var_632[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_798 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_798 || param1.desktop.height - param1.y < const_1122;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_536.length)
         {
            if(var_536[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_632[_loc3_].length)
                  {
                     repositionWindow(var_632[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
