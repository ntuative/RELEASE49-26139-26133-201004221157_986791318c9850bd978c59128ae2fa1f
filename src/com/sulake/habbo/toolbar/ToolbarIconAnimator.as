   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_857.push(new XML());
               var_856.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_856[var_52] = param6.clone();
         }
      ...
      {
         if(var_1267 == true || var_720 == 0)
         {
            if(false)
            {
               ++var_52;
               if(var_52 >= var_857.length)
               {
                  var_52 = 0;
                  ++var_720;
               }
      ...
      {
         return var_857.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1267 == false && var_720 == 1 && var_1291 != var_32;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_52 <= var_856.length)
         {
            _loc2_ = var_856[var_52];
