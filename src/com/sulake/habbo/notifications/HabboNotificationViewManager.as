   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < var_230.length)
         {
            ...
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_644 + const_500;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_1968,var_420,var_194);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_644 < 540;
      }
   }
}
