package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1437:String = "noconvinfo";
      
      private static const const_1438:String = "messageinput";
      ...
      private var var_1358:ITextWindow;
      
      private var var_1357:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1357 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_779 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_249 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1357.prepare(var_779);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_941,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1382,true);
         var_14.header.setParamFlag(HabboWindowParam.const_685,false);
         var_14.header.setParamFlag(HabboWindowParam.const_978,true);
         var_14.content.setParamFlag(HabboWindowParam.const_685,false);
         var_14.content.setParamFlag(HabboWindowParam.const_978,true);
         var_14.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1358 = ITextWindow(var_14.findChildByName("info_text"));
         var_1358.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_249.y = Util.method_1(var_14.content);
         var_249.width = _friendList.tabs.windowWidth;
         var_249.visible = true;
         var_14.content.height = Util.method_1(var_14.content);
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_987,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_685,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_941,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1590 = var_14.height;
         var_1591 = var_14.width;
