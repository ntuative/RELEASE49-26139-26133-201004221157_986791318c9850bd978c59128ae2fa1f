package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_683 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_683.procedure = onSearchInput;
         var_683.addEventListener(WindowKeyboardEvent.const_148,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_49.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_307,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_683.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
