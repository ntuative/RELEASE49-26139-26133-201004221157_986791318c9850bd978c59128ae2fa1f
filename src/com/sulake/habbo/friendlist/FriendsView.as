package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_618:String = "bg";
       
      
      private var var_2173:IContainerButtonWindow;
      
      private var var_2174:IContainerButtonWindow;
      
      private var var_2175:IContainerButtonWindow;
      
      private var var_2176:IContainerButtonWindow;
      ...
      {
         var_2174 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2175 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2173 = initButton("room_invite",onInviteButtonClick,param1);
         var_2176 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_618);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2174,isEnableMinimailButton(_loc1_));
         setEnabled(var_2175,isEnableHomeButton(_loc1_));
         setEnabled(var_2173,isEnableInviteButton(_loc1_));
         setEnabled(var_2176,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_618);
