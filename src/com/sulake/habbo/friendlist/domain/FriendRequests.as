package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_808;
         var_427.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_427.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      {
         var_221.push(param1);
         var_427.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            Util.remove(var_221,_loc4_);
            if(false)
            {
               var_427.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
