package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1419:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_299 && _loc4_.state != FriendRequest.const_313)
            {
      ...
      {
         var_1436 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1437 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1437.procedure = onDismissAllButtonClick;
         var_1436.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_808)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1436,_loc1_);
         setEnabled(var_1437,_loc1_);
      }
