package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_179:String = "face";
      ...
      private var var_1453:OpenedToWebPopup;
      
      private var var_822:IAvatarRenderManager;
      
      private var var_194:IHabboToolbar;
      
      private var var_430:FriendListTabs;
      ...
      private var var_1452:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_572:ISessionDataManager;
      
      private var var_344:FriendRequests;
      
      private var var_1697:int;
      
      var var_89:FriendCategories;
      
      private var var_1841:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_821:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1841 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_89 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1452 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_344.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_344.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_430.findTab(FriendListTab.const_91).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_572 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_344 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_89.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_89.addCategory(new FriendCategory(FriendCategory.const_806,getText("friendlist.friends")));
         var_89.addCategory(new FriendCategory(FriendCategory.const_379,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_89.addFriend(new Friend(_loc4_));
         }
         var_430 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_492)
         {
            var_492 = new Timer(120000);
            var_492.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_492.start();
         }
         getBuddyRequests();
         registerListeners();
         var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_492.stop();
            var_492.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_492 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_120)
         {
            var_120.release(new IIDHabboMessenger());
            var_120 = null;
         }
         if(var_156)
         {
         ...
         if(var_822)
         {
            var_822.release(new IIDAvatarRenderManager());
            var_822 = null;
         }
         if(var_821)
         {
            var_821.release(new IIDHabboNotifications());
            var_821 = null;
         }
         if(var_194)
         {
         ...
         if(var_572)
         {
            var_572.release(new IIDSessionDataManager());
            var_572 = null;
         }
         super.dispose();
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_120 = param2 as IHabboMessenger;
      ...
      {
         var _loc1_:String = var_156.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_430.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_302));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1452.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_344.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_572.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_572.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_344.limit)
         {
            var_344.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_430.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_822.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_344.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_430.findTab(FriendListTab.const_91);
      ...
      {
         var_821 = param2 as IHabboNotifications;
      ...
      {
         return var_156.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1453 == null)
         {
            var_1453 = new OpenedToWebPopup(this);
         }
         var_1453.show(x,y);
      }
