package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_936:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_539 = new Timer(100);
         var_539.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_39 = new Array();
         ...
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,80,"g"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,74,"h"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,416,"o"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,352,"p"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,304,"q"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,336,"r"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,748,"u"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_61,438,"v"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_54,540,"t"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_54,512,"w"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_54,396,"x"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_54,440,"y"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_54,456,"z"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_54,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(var_539)
         {
            var_539.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_539.reset();
            var_539 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_936.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1375 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1375 = true;
            _loc3_.y = 1;
