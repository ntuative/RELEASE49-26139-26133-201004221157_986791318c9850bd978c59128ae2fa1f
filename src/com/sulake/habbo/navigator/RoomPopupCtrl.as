package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1754 = new RoomThumbnailRenderer(param1);
         var_907 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_168,var_107.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_907.refreshTags(_loc1_,var_107.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1754.refreshThumbnail(_loc1_,var_107.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_168,var_107);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_168,!true ? getEventCtg(var_107.categoryId) : getRoomCtg(var_107.categoryId));
         refreshRoomDesc(var_168,var_107);
         refreshExtraCont();
         refreshInfo(var_168,"trading_allowed",var_107.allowTrading);
         ...
         var_168.height = Util.method_1(var_168);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_228,Tabs.const_218,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
