package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1979:IButtonWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_715.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_847.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1500.visible = true;
         var_1980.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_715.setText(param1.eventDescription);
         var_847.setText(getTagFromEvent(param1,1));
         var_849.setText(getTagFromEvent(param1,2));
         var_1249.visible = false;
         var_1251.visible = true;
         var_1250.visible = true;
         var_1499.visible = false;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1500 = IWindowContainer(find("event_type_disabled_cont"));
            var_1980 = ITextWindow(find("event_type_disabled_text"));
            var_1499 = ITextWindow(find("create_caption"));
            var_1501 = ITextWindow(find("edit_caption"));
            var_1249 = IButtonWindow(find("create_button"));
            var_1251 = IButtonWindow(find("edit_button"));
            var_1979 = IButtonWindow(find("cancel_button"));
            var_1250 = IButtonWindow(find("end_button"));
            var_848 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1249,onCreateButtonClick);
            Util.setProcDirectly(var_1251,onEditButtonClick);
            Util.setProcDirectly(var_1250,onEndButtonClick);
            Util.setProcDirectly(var_1979,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_715 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_847 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_715.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
