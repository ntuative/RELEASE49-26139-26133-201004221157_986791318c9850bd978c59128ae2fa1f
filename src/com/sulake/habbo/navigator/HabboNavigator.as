package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_811:RoomCreateViewCtrl;
      
      private var var_1754:RoomThumbnailRenderer;
      
      private var var_194:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_568:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_430:Tabs;
      
      private var var_257:MainViewCtrl;
      
      private var var_1778:Array;
      
      private var var_1048:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_568 = new RoomInfoViewCtrl(this);
         var_811 = new RoomCreateViewCtrl(this);
         var_1754 = new RoomThumbnailRenderer(this);
         var_1048 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_430 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_257.startSearch(Tabs.const_228,Tabs.const_306,param1);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_156.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_194 != null)
         {
            var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_257.startSearch(Tabs.const_271,Tabs.const_211);
         var_430.getTab(Tabs.const_271).tabPageDecorator.tabSelected();
      }
