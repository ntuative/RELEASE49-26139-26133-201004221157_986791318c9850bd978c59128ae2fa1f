package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1739:IWindowContainer;
      ...
      private var var_1426:IButtonWindow;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1426,this._model.mode != ThumbnailEditorModel.const_58);
         setEnabled(var_1427,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1426 = IButtonWindow(find("top_tab"));
         var_1427 = IButtonWindow(find("obj_tab"));
         var_1738 = IWindowContainer(find("tile_grid"));
         var_1739 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1426,onTopTabButton);
         Util.setProcDirectly(var_1427,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1738;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1739;
