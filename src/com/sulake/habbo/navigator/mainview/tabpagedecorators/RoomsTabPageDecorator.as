package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_274,Tabs.const_328);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_274,Tabs.const_552);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_274,Tabs.const_328,"" + _loc3_);
         }
      }
