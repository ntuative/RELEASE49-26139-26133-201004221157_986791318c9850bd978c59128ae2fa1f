package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1443:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_228,Tabs.const_218,"-1",MainViewCtrl.const_555);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1443 == null)
         {
            ...
            var_1443 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1443.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
