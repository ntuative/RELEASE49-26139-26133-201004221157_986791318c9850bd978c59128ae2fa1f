package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_640,RoomWidgetEcotronBoxOpenMessage.const_524,RoomWidgetEcotronBoxOpenedMessage.const_1292];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_640:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_524:
