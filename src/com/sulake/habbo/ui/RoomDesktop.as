package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1228:Boolean = true;
      ...
      private var var_601:IAvatarRenderManager = null;
      ...
      private var var_353:ISessionDataManager = null;
      
      private var var_1949:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_435,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_649,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_1227 = !var_250.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_38.roomId,var_38.roomCategory,var_263[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_435,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_649,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_794 = null;
         ...
         if(var_194 && false)
         {
            ...
            var_194.events.removeEventListener(HabboToolbarEvent.const_63,onHabboToolbarEvent);
         }
         var_194 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1949);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_194 != null)
         {
            var_172.toolbarSize = var_194.size;
            var_172.toolbarOrientation = var_194.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_738:
               ...
               if(var_659 != null && _loc3_ == RoomObjectCategoryEnum.const_38)
               {
                  _loc7_ = var_38.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_316)
                  {
                     var_659.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_257:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_113:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_561,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_725);
            _loc13_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_611);
            _loc14_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_661);
            _loc15_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_517);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_370:
               ...
               var_173 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_335,WindowStyle.const_312,WindowParam.const_93) as IToolTipWindow;
               var_173.setParamFlag(WindowParam.const_51,false);
      ...
      {
         if(var_18 != null && var_38 != null && var_1227 && var_1228)
         {
