   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_899,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_562,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_473,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_562,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_811,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_982,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_473,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_473:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_413));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_525);
         _loc1_.push(RoomWidgetDanceMessage.const_666);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_709);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_695);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_684);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_575);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_705);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_518);
         _loc1_.push(RoomWidgetStopEffectMessage.const_607);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1221);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_882);
         _loc1_.push(RoomWidgetToolbarMessage.const_560);
         ...
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_858);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_596);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_558);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_645);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1181);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_537);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_600);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_559);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_746));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_558:
               ...
               break;
            case RoomWidgetWaveMessage.const_525:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_666:
               if(_container != null && false)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_695:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_684:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_518:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_871)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_705:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_999:
                        _catalog.openCatalogPage(CatalogPageName.const_1359,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_908:
                        var_11.toggleInventoryPage(InventoryCategory.const_261);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1392:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_575:
            case RoomWidgetStopEffectMessage.const_607:
            ...
            case RoomWidgetNavigateToRoomMessage.const_882:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_596:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_560:
            ...
            case RoomWidgetToolbarMessage.const_643:
               ...
               if(var_194 && false)
               {
                  var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_362,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_511:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_467));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_645:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_537:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_304,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_600:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_304,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_559:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_468));
               }
               break;
            default:
