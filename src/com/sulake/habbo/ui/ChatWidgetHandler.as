package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_530.length)
            {
               _loc2_ = var_530.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_530.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_754.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_324:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_530.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_754.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_523,RoomWidgetChatSelectAvatarMessage.const_730];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_523:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_147,_container.roomSession,0,"Version 26139-26133-201004221124");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_730:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_916 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_916);
            }
            if(var_532 == null)
            {
               var_531.x = 0;
               var_531.y = 0;
               var_531.z = 0;
               var_532 = _loc4_.getScreenPoint(var_531);
               var_916 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_531.x = 0;
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_532.x || _loc8_.y != var_532.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_532,_loc5_));
