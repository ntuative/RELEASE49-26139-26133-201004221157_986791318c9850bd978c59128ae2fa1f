package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1136:String = "poster";
      ...
      {
         return [RoomSessionPresentEvent.const_249];
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_673,RoomWidgetPresentOpenMessage.const_568,RoomWidgetPresentOpenedMessage.const_1272];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(_container != null && false && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_249:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_82:
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1136)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_317:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_428,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_673:
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_568:
