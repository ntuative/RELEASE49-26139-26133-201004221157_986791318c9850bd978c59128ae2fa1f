package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_104:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_717,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_713];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_713:
      ...
      {
         return [RoomSessionDoorbellEvent.const_104,RoomSessionDoorbellEvent.const_121,RoomSessionDoorbellEvent.const_57];
      }
