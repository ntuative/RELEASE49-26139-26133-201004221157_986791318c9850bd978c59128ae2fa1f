package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_621,RoomWidgetStickieSendUpdateMessage.const_603,RoomWidgetStickieSendUpdateMessage.const_405];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_621:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_630,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
                     _container.events.dispatchEvent(_loc11_);
                  }
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_405:
