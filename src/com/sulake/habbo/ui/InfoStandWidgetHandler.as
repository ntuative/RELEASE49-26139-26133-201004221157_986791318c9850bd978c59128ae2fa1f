package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_110,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_110,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_554);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1023);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_825);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_891)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_544);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_206)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_235)
               {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_916;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1162);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_607.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_607.add(_loc2_.petId,_loc5_);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_550);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_651);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_683);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1212);
         _loc1_.push(RoomWidgetPetCommandMessage.const_689);
         _loc1_.push(RoomWidgetPetCommandMessage.const_647);
         _loc1_.push(RoomWidgetUserActionMessage.const_706);
         _loc1_.push(RoomWidgetUserActionMessage.const_378);
         return _loc1_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_607 != null)
         {
            _loc1_ = var_607.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_607.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_429)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_680:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_836,_loc3_.name);
            ...
            case RoomWidgetRoomTagSearchMessage.const_651:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_683:
            ...
            case RoomWidgetPetCommandMessage.const_647:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_689:
