package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_662,_data.flatId),var_52,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_429);
         if(param1.flatId != var_429)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_429);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1275,_loc2_,var_435.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1059.isSelected,var_1058.isSelected,var_730.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1297);
      }
      ...
      public function populate() : void
      {
         ...
         var_730 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_1059 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
         var_1058 = ICheckBoxWindow(var_52.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_429));
         Logger.log("BEGINNING TO SHOW: " + var_429);
      }
   }
}
