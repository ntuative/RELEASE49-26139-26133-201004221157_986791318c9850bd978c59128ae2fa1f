package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1661:String = "picked_issues";
      ...
      private const const_1659:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_238:ITabContextWindow;
      
      private var var_1547:PickedIssuesView;
      
      private var var_355:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_355.view.width = var_238.container.width;
         var_355.view.height = var_238.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1659:
               if(var_1548 == null)
               {
                  var_1548 = new MyIssuesView(issueManager,this,var_238.container);
               }
               return var_1548;
            case const_1660:
               if(var_1546 == null)
               {
                  var_1546 = new OpenIssuesView(issueManager,this,var_238.container);
               }
               return var_1546;
            case const_1661:
               if(var_1547 == null)
               {
                  var_1547 = new PickedIssuesView(issueManager,this,var_238.container);
               }
               return var_1547;
            default:
               return null;
