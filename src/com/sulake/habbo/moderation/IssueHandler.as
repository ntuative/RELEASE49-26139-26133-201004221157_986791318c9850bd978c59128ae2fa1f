package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_445:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_445 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_1090 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_445.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_118.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1090.load(_loc4_,var_118.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_60,WindowTracker.const_863,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_445 = new UserInfoCtrl(_window,var_60,_loc3_.message);
            var_445.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
