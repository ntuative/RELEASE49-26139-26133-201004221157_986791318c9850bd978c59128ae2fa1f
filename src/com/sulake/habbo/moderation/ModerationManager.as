package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_1875:ModeratorInitMessageParser;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1873:WindowTracker;
      ...
      private var var_1876:ModerationMessageHandler;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         {
            _connection = param1;
            var_1876 = new ModerationMessageHandler(this);
         }
      }
