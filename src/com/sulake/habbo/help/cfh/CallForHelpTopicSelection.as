package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_756 == null || _loc3_ < 0 || _loc3_ >= var_756.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_756[_loc3_];
            main.showUI(HabboHelpViewEnum.const_553);
            main.tellUI(HabboHelpViewEnum.const_553,null);
         }
      }
   }
}
