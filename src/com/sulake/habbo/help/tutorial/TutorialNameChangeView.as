package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private var var_282:IBorderWindow;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_368);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_368);
         }
         if(var_282 == null)
         {
            var_282 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_282 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_282);
            var_282.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_282.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_881 = new NameSuggestionListRenderer(_main);
