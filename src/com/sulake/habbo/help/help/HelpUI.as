package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1766:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26139-26133-201004221124");
         var_194 = param5;
         var_99 = new Map();
         var_99.add(HabboHelpViewEnum.const_1252,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_141,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_394,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_246,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_200,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_674,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_325,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_553,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_217,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_99.add(HabboHelpViewEnum.const_920,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_737,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_256 == HabboHelpViewEnum.const_141 || false)
         {
            return;
         }
         if(var_394 == null)
         {
            ...
            var_394 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_394 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_394 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_394 as IWindow);
      ...
      {
         return var_99.getValue(var_256);
      }
      ...
      {
         var_1765 = param1;
         var _loc2_:IHelpViewController = var_99.getValue(HabboHelpViewEnum.const_141) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_217:
               showUI(HabboHelpViewEnum.const_217);
               break;
            case CallForHelpResultEnum.const_816:
               showUI(HabboHelpViewEnum.const_920);
               break;
            case CallForHelpResultEnum.const_947:
      ...
      {
         var _loc3_:* = null;
         if(var_256 == HabboHelpViewEnum.const_141)
         {
            return;
         }
         if(true)
         {
            ...
            var_567.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_567.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_394.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_567[1],var_567[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_567[0],var_567[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.width = _loc1_.width + var_1432;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_256);
            return;
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_451));
      }
