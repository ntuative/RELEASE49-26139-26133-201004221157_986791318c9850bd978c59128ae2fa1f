package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_818:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_464,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_732));
      }
      ...
      {
         var_115.clubPeriods = param1;
         var_115.clubDays = param2;
         var_115.clubHasEverBeenMember = param3;
         var_115.isVIP = param4;
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_145));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_811));
      }
      ...
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_338));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_242:
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_242));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_353 = ISessionDataManager(param2);
      ...
      {
         return var_115.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_46.getValue(InventoryCategory.const_298) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_997 = new IncomingMessages(this);
      ...
      {
         return var_115.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_115.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_261));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_464,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_298,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_353);
         var_46.add(InventoryCategory.const_261,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_46.add(InventoryCategory.const_732,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_353);
         var_46.add(InventoryCategory.const_338,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_46.add(InventorySubCategory.const_242,_loc8_);
         ...
         var_46.add(InventoryCategory.const_145,_loc10_);
