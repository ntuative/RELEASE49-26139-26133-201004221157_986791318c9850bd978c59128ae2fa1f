package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1033:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_91 = var_584.height;
         var_1032 = param5;
         var_850 = param6;
         var_234 = Math.floor(var_1032 / _thumbWidth);
         var_19 = new BitmapData(var_1032,var_850);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_19.height < var_850)
         {
            _loc12_ = new BitmapData(var_19.width,var_850);
      ...
      private function getList() : Array
      {
         ...
         if(var_1033 != null)
         {
            _loc1_ = var_1033.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_19 = new BitmapData(Math.max(var_234 * _thumbWidth,var_1032),Math.max(var_507 * var_91,var_850),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_234 && var_19.height < _loc3_.y * var_91)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_234 - 1),var_91);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_234 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_91),null,null,true);
         _loc4_ = new Rectangle(0,var_91,_thumbWidth * (var_234 - 1),0 - var_91);
