package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_795:uint = 2577770;
      
      public static const const_834:int = 0;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_917)
            {
            ...
            var_371.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_430);
            var_371.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1592 == null)
         {
            var_1592 = createMinimizedWindow();
         }
         if(!var_2228)
         {
            return var_63;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_63)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_796) : uint(const_795);
            }
