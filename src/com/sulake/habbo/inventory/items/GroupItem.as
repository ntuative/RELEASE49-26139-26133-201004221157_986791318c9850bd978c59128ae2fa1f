package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1471:Number;
      
      protected var _type:int;
      
      protected var _roomEngine:IRoomEngine;
      
      protected var var_2292:BitmapData;
      ...
      private const const_1650:int = 8947848;
      ...
      private const const_1426:Number = 0.2;
      
      protected var var_1392:Boolean;
      
      private const const_1425:Number = 1;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1471));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1391);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1426;
               _loc1_.blend = const_1426;
            }
            else
            {
               _window.blend = const_1425;
               _loc1_.blend = const_1425;
            }
         }
         if(isSelected)
         {
