package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_212,onObjectPlaced);
         var_475 = new Timer(const_1051,1);
      ...
      {
         return var_48.getSubCategoryViewId() == InventorySubCategory.const_242;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_392.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_392.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_212,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_242:
               ...
               break;
            case InventorySubCategory.const_1016:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_48.checkCategoryInitilization(InventoryCategory.const_298);
         ...
         if(param1 == InventoryCategory.const_78 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_333:
                  var_48.toggleInventoryPage(InventoryCategory.const_145);
            }
         }
      }
      ...
      {
         if(var_803 && param1.type == RoomEngineObjectEvent.const_212)
         {
            var_48.showView();
            var_803 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_301 || _loc3_.category == FurniCategory.const_331 || _loc3_.category == FurniCategory.const_315)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_392.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_392 = new Map();
         var_392.add(const_45,new Array());
         var_392.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
