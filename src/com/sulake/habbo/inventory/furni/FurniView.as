package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1664:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_516 = new Map();
         var_516.add(FurniModel.const_45,new FurniGridView(_model,FurniModel.const_45,_windowManager,_assetLibrary,_roomEngine));
         var_516.add(FurniModel.const_46,new FurniGridView(_model,FurniModel.const_46,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_718 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
