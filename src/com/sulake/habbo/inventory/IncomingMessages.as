package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_732);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_298))
         {
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_11.toggleInventorySubPage(InventorySubCategory.const_242);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Array = _loc2_.method_8();
         _loc4_ = 0;
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_261);
      }
