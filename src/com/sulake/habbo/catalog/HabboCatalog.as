package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_317:CatalogViewer;
      ...
      {
         return var_353.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_115.credits = _loc3_.balance;
         updatePurse();
         if(!var_2167 && var_529 != null)
         {
            var_529.playSound(HabboSoundTypesEnum.const_983);
         }
         var_2167 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_353.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_82)
         {
            _loc3_ = var_353.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_444 == null)
         {
            var_444 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_98:
               var_1326 = param1.session.isPrivateRoom;
               if(var_86 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_156.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_156.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2165 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_115.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_115.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_115.isVIP = _loc2_.isVIP;
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_206 == null)
            {
               var_206 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_206.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_444.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new RecyclerStatusMessageEvent(method_6));
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_154)
         {
            _loc3_ = var_156.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_115.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_115.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_115.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_115.clubPeriods));
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_115.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2166 && var_529 != null)
         {
            var_529.playSound(HabboSoundTypesEnum.const_897);
         }
         var_2166 = false;
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_317 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_317.habboCatalog = this;
      }
