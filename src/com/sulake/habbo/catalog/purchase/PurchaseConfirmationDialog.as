package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1431:uint = 4.293848814E9;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_835;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_835,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1431) : uint(const_1432);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_396,var_77,var_1013);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_262) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_835);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_575[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_576[var_192]);
         _catalog.purchaseProductAsGift(var_396,var_77,var_1013,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_125:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_1943 == _loc3_.text)
               {
                  return;
               }
            ...
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowKeyboardEvent.const_624:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_262 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_262 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1442 = _loc1_.stuffTypes;
            var_575 = _loc1_.boxTypes;
            var_576 = _loc1_.ribbonTypes;
            var_835 = var_1442[0];
            _boxIndex = var_575[0];
            var_192 = var_576[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_262) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_262);
         }
         var_262 = param1;
         if(var_262 < 0)
         {
            var_262 = _loc2_.numListItems - 1;
         }
         if(var_262 >= _loc2_.numListItems)
         {
            var_262 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_262) as IWindowContainer;
