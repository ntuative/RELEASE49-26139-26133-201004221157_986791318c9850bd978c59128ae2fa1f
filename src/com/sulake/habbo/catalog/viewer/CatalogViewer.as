package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1484:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_396 != null)
         {
            if(var_396.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_396.window);
            var_396.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1484);
         var_396 = _loc5_;
      ...
      {
         return var_396.dispatchWidgetEvent(param1);
      }
