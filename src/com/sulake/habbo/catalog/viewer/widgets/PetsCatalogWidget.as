package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_448 >= var_323.length)
         {
            return "";
         }
         var petColor:IPetColor = var_323[var_448] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_631[var_1593] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_448 < 0 || var_448 > var_323.length)
         {
            var_448 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_591.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_125,onTextWindowEvent);
         var_591 = new Map();
         ...
         var_928 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_323 = [];
         var_631 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_928);
               if(_loc11_)
               {
                  var_631 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_631.length)
         {
            _loc12_ = var_631[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_928,_loc12_.id),getRaceLocalizationKey(var_928,_loc12_.id)));
            _loc6_++;
         }
         var_591.add(var_928,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_869,onApproveNameResult);
         _loc5_ = var_591.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_591.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_448 >= 0 && var_448 < var_323.length)
         {
            _loc7_ = var_323[var_448] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_631[var_1593] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_928,_loc3_.id,_loc2_,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_322,AvatarAction.const_535);
