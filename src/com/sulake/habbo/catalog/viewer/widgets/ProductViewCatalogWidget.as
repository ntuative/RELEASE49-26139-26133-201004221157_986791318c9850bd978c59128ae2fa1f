package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1268:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_1268 != null)
         {
            var_1268.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1188.text = "${" + _loc3_.name + "}";
            var_1189.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1188.text = "${" + _loc2_.localizationId + "}";
            var_1189.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_385:
                  _loc4_ = var_1269.clone();
                  if(var_592 != null)
                  {
                     var_592.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_592,var_1268,var_1275);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_203:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_322,AvatarAction.const_641);
                              _loc13_.appendAction(AvatarAction.const_743,_loc6_.productClassId);
      ...
      {
         var_1188 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1189 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1513 = new Point(var_82.x,var_82.y);
         var_592 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1268 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_592 == null)
         {
         ...
         var_1269 = _loc2_.content as BitmapData;
