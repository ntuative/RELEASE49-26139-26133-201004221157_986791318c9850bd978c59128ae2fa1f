package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1028 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1028 != null)
         {
            var_1028.addEventListener(WindowKeyboardEvent.const_624,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1028.text));
      }
   }
}
