package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_860:MarketPlaceOfferData;
      
      private const const_1429:int = 1;
      
      private const const_1655:int = 40;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1428,_loc2_.length);
         if(!var_421)
         {
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_422.length)
         {
            _loc4_ = 0;
         }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_859 >= var_591.length)
            {
               return true;
            }
            addListItem(var_591.getWithIndex(var_859));
            ++var_859;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_860.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_125)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_422));
            _loc7_.selection = 0;
         }
      }
