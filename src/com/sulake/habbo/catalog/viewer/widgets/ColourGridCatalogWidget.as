package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1171 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_294 = null;
         for each(_loc1_ in var_1172)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1171) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_674.width,var_674.height,true,0);
               _loc3_.bitmap.copyPixels(var_674,var_674.rect,new Point(0,0));
            }
