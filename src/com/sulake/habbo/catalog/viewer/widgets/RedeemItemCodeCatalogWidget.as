package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1037 != null)
         {
            var_1037.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1036 != null)
         {
            var_1036.removeEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1037 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1037 != null)
         {
            var_1037.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1036 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1036 != null)
         {
            var_1036.addEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
