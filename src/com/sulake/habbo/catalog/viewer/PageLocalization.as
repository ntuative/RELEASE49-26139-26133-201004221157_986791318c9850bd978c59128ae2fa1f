package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_193:Dictionary = new Dictionary();
      
      private static const const_783:Object = {"frontpage3":[7,8]};
      
      private static const const_1081:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_784:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      {
         const_193["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_193["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_193["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_193["collectibles"] = ["ctlg_collectibles_link"];
         const_193["club1"] = ["ctlg_text_5"];
      }
