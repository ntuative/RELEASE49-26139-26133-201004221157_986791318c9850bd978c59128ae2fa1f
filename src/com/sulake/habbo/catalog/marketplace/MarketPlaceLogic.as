package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1667:int = 3;
      
      public const const_1561:int = 2;
      ...
      private var var_1920:MarketplaceItemStats;
      ...
      {
         if(param1.furniCategoryId != var_1730 || param1.furniTypeId != var_1727)
         {
            return;
         }
         var_1920 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1561,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1918 = _loc3_.creditsWaiting;
         var_191 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_206)
         {
            var_206 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_206.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_1921,var_1922,var_1919,var_1917);
      }
