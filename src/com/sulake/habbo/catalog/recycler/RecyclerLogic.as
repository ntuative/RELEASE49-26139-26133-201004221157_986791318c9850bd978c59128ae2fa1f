package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1428)
         {
            case RecyclerStatusMessageEvent.const_1352:
               var_254 = const_347;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_1003:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1428 != RecyclerStatusMessageEvent.const_1003;
      }
      
      private function get statusActive() : Boolean
      {
         return var_254 != const_760;
      }
      ...
      {
         return active && var_254 == const_347;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_925:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1267:
