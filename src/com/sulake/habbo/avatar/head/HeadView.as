   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_35)
         {
            ...
            var_35["null"] = new AvatarEditorGridView(_model,FigureData.const_144,_windowManager,_assetLibrary);
            ...
            var_35["null"] = new AvatarEditorGridView(_model,FigureData.const_181,_windowManager,_assetLibrary);
         }
         else
         {
