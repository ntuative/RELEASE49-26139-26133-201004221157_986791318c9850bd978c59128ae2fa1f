package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_892:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_741.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_162)
         {
            ...
            var_525["null"] = new FigureData(this);
            var_525["null"] = new FigureData(this);
            _loc1_ = var_525["null"];
            _loc2_ = var_525["null"];
            ...
            var_89 = new Map();
            var_440 = new Map();
            var_89.add(AvatarEditorFigureCategory.const_922,new BodyModel(this));
            var_89.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            var_89.add(AvatarEditorFigureCategory.const_287,new TorsoModel(this));
            var_89.add(AvatarEditorFigureCategory.const_1334,new LegsModel(this));
            var_89.add(AvatarEditorFigureCategory.const_1254,new HotLooksModel(this));
            var_440.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_440.add(AvatarEditorSideCategory.const_457,new ClubPromoModel(this));
            var_162 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1067 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1561;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1067 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1105)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1610.clone() as IWindowContainer,param1,_loc14_);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1153)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1067 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_440.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_892 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_741.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_440.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_922);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_741 = var_601.getFigureData(AvatarType.const_83);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_601 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1067 = param3;
         var _loc4_:FigureData = var_525[param2];
         if(_loc4_ == null)
         {
            return;
         }
