package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1100:String = AvatarSetType.const_41;
      
      private static const const_1101:String = "Default";
      
      private static const const_1099:int = 125;
       
      
      private var var_1302:int = 0;
      
      private var var_314:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String, param6:String = null)
      {
         ...
         if(var_199 == null)
         {
            var_199 = AvatarScaleType.const_56;
         }
         ...
         var_314 = new AvatarFigureContainer(param3);
         if(param6)
         {
            ...
            if(_loc7_)
            {
               ...
               {
                  if(!var_314.hasPartType(_loc9_))
                  {
                     _loc10_ = var_53.getDefaultPartSet(_loc9_,param6);
                     if(_loc10_)
                     {
                        var_314.updatePart(_loc9_,_loc10_.id,[0]);
                     }
                  }
                  else
                  {
                     _loc11_ = _loc8_.getSetType(_loc9_);
                     _loc12_ = _loc11_.getPartSet(var_314.getPartSetId(_loc9_));
                     if(!_loc12_)
                     {
                        _loc13_ = var_53.getDefaultPartSet(_loc9_,param6);
                        var_314.updatePart(_loc9_,_loc13_.id,[0]);
                     }
                  }
               }
            }
         ...
         {
            _loc14_ = var_314.getPartSetId("pbd");
            solvePetAvatarTypeAndBreed(_loc14_);
            var_1302 = var_1060;
         }
         var_126 = new AvatarImageCache(var_53,this,_assets,var_199);
         setDirection(const_1100,const_1098);
         var_200 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1303;
         if(param2 < AvatarDirectionAngle.const_1239)
         {
            param2 = AvatarDirectionAngle.const_670 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_670)
         {
            param2 -= NaN;
         }
         if(var_698 == AvatarType.PET && param1 == AvatarSetType.const_50)
         {
            ...
            _loc3_ = var_53.renderManager.petDataManager.getPetData(var_1302);
            if(_loc3_ != null)
            {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         var_434 = false;
         var _loc1_:Array = var_53.sortActions(var_200);
         if(_loc1_ == null)
         {
            var_611 = new Array(0,0,0);
         }
         else
         {
            var_611 = var_53.getCanvasOffsets(_loc1_,var_199,var_92);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1303 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_529)
            {
               var_434 = true;
            }
            if(_loc2_.actionType == AvatarAction.const_420)
            {
               var_434 = true;
            }
      ...
      {
         return var_53.getPartColor(var_314,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_53.getCanvas(var_199,var_179.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_53.getBodyParts(param1,var_179.definition,var_92);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_698 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_53.getParts(_loc9_,var_314,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  if(var_199 == AvatarScaleType.SMALL)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_53.getPartActionOffset(getSubType(),var_199,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = var_53.getCanvas(var_199,var_179.definition.geometryType);
         if(_image == null || _loc4_ != null && (_image.width != _loc4_.width || _image.height != _loc4_.height))
         {
            _loc4_ = var_53.getCanvas(var_199,var_179.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,var_480);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               if(var_698 == AvatarType.PET)
               {
                  ...
                  _loc15_ = var_53.getParts(_loc8_,var_314,_loc13_,"pet",_loc12_.getDirection(),[]);
                  _loc16_ = var_1302 < 3;
                  ...
                  {
                     _loc18_ = _loc15_[0];
                     _loc19_ = _loc18_.getFrameIndex(var_480);
                     _loc20_ = var_92;
                     _loc21_ = 1;
                     switch(var_92)
                     {
                     ...
                     _loc22_ = var_53.getPartActionOffset(getSubType(),var_199,_loc8_,_loc14_,_loc19_,_loc20_);
                     if(_loc22_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_179 = new ActiveActionData(AvatarAction.const_885);
         var_179.definition = var_53.getActionDefinition(const_1101);
      ...
      {
         return var_53.getBodyPartData(param1.animation.id,var_480,param1.id);
      }
