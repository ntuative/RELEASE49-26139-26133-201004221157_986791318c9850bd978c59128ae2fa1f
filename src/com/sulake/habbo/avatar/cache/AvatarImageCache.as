package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_778:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_566)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_398)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_53.getParts(param1,(var_778 as AvatarImage).getFigure(),_loc6_,var_1156,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_53.getCanvas(var_199,var_1156);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1276[param1])
            {
            ...
            _loc9_ = var_199 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_199 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            ...
            else
            {
               ...
               if((_loc29_ == AvatarAction.const_860 || _loc29_ == AvatarAction.const_529) && (_loc6_ == AvatarBodyPartType.const_287 || _loc6_ == AvatarBodyPartType.const_1191 || _loc6_ == AvatarBodyPartType.const_1187) && _loc7_.color != null)
               {
         ...
         if(_loc17_)
         {
            if(var_199 == AvatarScaleType.const_56)
            {
               _loc25_.x += 67;
            }
            else
