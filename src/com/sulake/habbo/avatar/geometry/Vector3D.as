package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_80 * param1.x - var_81 * param1.z;
      ...
      {
         return Math.sqrt(var_81 * var_81 + _y * _y + var_80 * var_80);
      }
      ...
      {
         return var_81 * param1.x + _y * param1.y + var_80 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_81 + "," + _y + "," + var_80 + "," + var_1003 + ")";
      }
