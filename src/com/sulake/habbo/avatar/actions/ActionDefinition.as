package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_2162 = String(param1.@activepartset);
         var_2164 = String(param1.@assetpartdefinition);
         var_2163 = String(param1.@lay);
         var_1156 = String(param1.@geometrytype);
         var_2035 = Boolean(parseInt(param1.@main));
         var_2158 = Boolean(parseInt(param1.@const_1024));
         var_2160 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1325 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_611.add(param1,new Map());
         }
         var _loc4_:Map = var_611.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_611.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1325.concat(getTypePrevents(param1));
      }
