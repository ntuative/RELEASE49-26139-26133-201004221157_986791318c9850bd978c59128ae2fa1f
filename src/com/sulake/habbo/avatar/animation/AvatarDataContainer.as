package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1524,var_1525,var_1522,_alphaMultiplier);
         var_995 = generatePaletteMapForGrayscale(var_1830,var_1829);
      }
      
      public function get reds() : Array
      {
         return var_995.getValue("reds") as Array;
      }
      ...
      {
         return var_995.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_995.getValue("greens") as Array;
      }
      ...
      {
         return var_995.getValue("alphas") as Array;
      }
