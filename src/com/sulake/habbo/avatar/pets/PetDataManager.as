package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_769.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_769.getValue(param1) as IPetData;
      }
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_769.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_769.getValue(key);
            if(petData != null)
            {
      ...
      {
         var _loc4_:PetData = var_769.getValue(param1);
         if(_loc4_ == null)
         {
