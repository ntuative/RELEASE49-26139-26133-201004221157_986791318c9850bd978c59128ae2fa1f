package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1905:PartOffsetData;
      
      private var var_830:AvatarActionManager;
      
      private var var_170:IAssetLibrary;
      
      private var var_1010:IAssetLibrary;
      
      private var var_1906:AvatarRenderManager;
      
      private var var_299:FigureData;
      ...
      private var var_1466:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_170 = param2;
         var_1010 = param3;
         var_299 = new FigureData();
         var_404 = new PartSetsData();
         _animationData = new AnimationData();
         var_1466 = new AvatarStructureDownloadSet();
         var_697 = new AnimationManager();
         var_698 = param4;
         var_1905 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_830.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_830.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_299.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_830.getActionDefinition(param1);
      }
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_830.getDefaultActionType();
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_299.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_299.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_698)
         {
            case AvatarType.const_83:
               ...
               var_1466.add(new AvatarStructureDownload(var_170,_loc5_,var_299));
               break;
            case AvatarType.PET:
         }
         var_1466.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_830 = new AvatarActionManager(var_170,var_698);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1215 = var_299.getMandatorySetTypeIds();
         return var_1215;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_299.getDefaultPartSet(param1,param2);
      }
      ...
      {
         return var_1905.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_299.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_299.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_830.sortActions(param1);
      }
   }
}
