package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1649:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private const const_1650:int = 13421772;
      
      private var var_432:Rectangle;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1533 = Math.max(var_1533,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_1018 + "_" + FigureData.const_273;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_432.width,var_432.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_1018 + "_" + FigureData.const_273;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1534 && _loc2_.colorLayerIndex > 0)
               {
