package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_735 >= 0 && var_180.length > var_735)
         {
            _loc2_ = var_180[var_735];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = var_239[0] as Array;
         ...
         {
            _loc7_ = var_239[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > var_203[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_203[param2],param2);
         var_203[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_203[param1])
         {
            return null;
         }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_239.length <= param1)
         {
            return null;
         }
         return var_239[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_180[var_735] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_239)
         {
            for each(_loc2_ in var_239 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_203 = new Array(param1.length);
         var _loc3_:int = 0;
