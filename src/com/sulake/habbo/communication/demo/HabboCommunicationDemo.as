package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_1422:String = "fuselogin";
      
      private var var_312:ICoreCommunicationManager;
      
      private var var_433:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            ...
            case DisconnectReasonEvent.const_1288:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1399:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1208:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2112)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_728 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_728);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1299,var_2111));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1422,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_433.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_433.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2110);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1422,"/");
      ...
      {
         var_728 = _habboConfiguration.getKey("sso.ticket",null);
         var_1299 = _habboConfiguration.getKey("flash.client.url","");
         var_2111 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_728 != null)
         {
            var_66.mode = HabboConnectionType.const_475;
            var_66.initConnection(HabboConnectionType.const_276);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_672);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2110 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_66.mode)
         {
            case HabboConnectionType.const_475:
               _loc6_ = "";
               ...
               break;
            case HabboConnectionType.const_985:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1176:
               var_610 = generateRandomHexString(30);
               var_433 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_433.init(var_610);
               _loc8_ = var_433.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var_433 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_433.init(_loc14_);
            _loc15_ = var_433.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_66.mode = HabboConnectionType.const_985;
            }
         }
         var_66.initConnection(HabboConnectionType.const_276);
      }
