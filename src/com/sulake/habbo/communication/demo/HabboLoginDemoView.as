package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_701:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_346.shockwaveClientUrl = var_114.shockwaveClientUrl;
         var_346.ssoTicket = var_114.ticket;
         ...
         var_114 = null;
         dispatchEvent(new Event(const_701));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1422,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_346.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_357,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1422,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_114 = new SSOTicket(var_346.assets,_loc2_,_loc1_);
