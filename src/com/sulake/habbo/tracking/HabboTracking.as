package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_227:PerformanceTracker = null;
      ...
      private var var_837:LagWarningLogger = null;
      
      private var var_836:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_227 = new PerformanceTracker();
         var_226 = new LatencyTracker();
         var_837 = new LagWarningLogger();
         var_1222 = new Array(const_776);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1336,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_532,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_879,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_672:
               trackLoginStep(HabboLoginTrackingStep.const_1190,String(_communication.port));
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_302:
      ...
      {
         var_156 = IHabboConfigurationManager(param2);
         if(var_156)
         {
            Component(var_156).events.addEventListener(HabboConfigurationEvent.const_166,onConfigurationLoaded);
            if(var_226 != null)
            {
               var_226.configuration = var_156;
            }
            if(var_227 != null)
            {
               var_227.configuration = var_156;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_250.events.addEventListener(AdEvent.const_410,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1945)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1207);
            var_1945 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_879,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_532,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_672,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_512,onHotelViewEvent);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_836)
            {
               var_836.release(new IIDHabboWindowManager());
               var_836 = null;
            }
            if(var_250)
            {
            ...
            if(var_171)
            {
               if(true)
               {
                  ...
                  Component(var_171).events.removeEventListener(HabboFriendListTrackingEvent.const_302,onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_156)
         {
            if(var_837 != null)
            {
               var_837.configure(var_156);
            }
            Component(var_156).events.removeEventListener(HabboConfigurationEvent.const_166,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_932);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_932,onCoreRunning);
         }
      }
      ...
      {
         var_836 = IHabboWindowManager(param2);
         if(var_836)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1014 > -1 && _loc2_ < var_1014)
         {
            ++var_1477;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1477);
         }
         if(var_1014 > -1 && _loc2_ - var_1014 > 15000)
         {
            ++var_1476;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1476);
         }
         var_1014 = _loc2_;
         if(var_227 != null)
         {
      ...
      {
         if(var_156 != null && Boolean(var_156.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_171).events.addEventListener(HabboFriendListTrackingEvent.const_302,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_156)
            {
               if(var_156.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_156.getKey("client.fatal.error.url");
                  ...
                  if(var_227 != null)
                  {
                     _loc4_["null"] = var_227.flashVersion;
                     _loc4_["null"] = var_227.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_512)
         {
