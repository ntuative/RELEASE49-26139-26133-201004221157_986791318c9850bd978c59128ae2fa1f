package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1065:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_616:uint = 0;
      
      public static const const_846:String = "AssetLibraryReady";
      
      public static const const_1313:String = "AssetLibraryUnloaded";
      
      public static const const_472:String = "AssetLibraryLoaded";
      
      public static const const_1231:String = "AssetLibraryLoadError";
      ...
      private var var_523:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_616;
         var_437 = new Dictionary(false);
         var_436 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_437)
         {
            _loc4_ = AssetTypeDeclaration(var_437[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_523)
         {
            AssetLibrary.fetchLibraryContents(this,var_524,var_359);
         }
         var_315 = true;
         dispatchEvent(new Event(AssetLibrary.const_472));
         dispatchEvent(new Event(AssetLibrary.const_846));
         if(var_523)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_436[param2.url];
         if(_loc4_ != null)
         {
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_437.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_437[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1065.splice(var_1065.indexOf(this),1);
            --var_616;
            var_436 = null;
            var_739 = null;
            _loadedAssets = null;
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_437)
         {
            _loc3_ = AssetTypeDeclaration(var_437[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_436[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_437[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
