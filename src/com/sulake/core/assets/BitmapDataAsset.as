package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      private var var_1176:AssetTypeDeclaration;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_1095 = BitmapDataAsset(param1).var_1095;
            var_1096 = BitmapDataAsset(param1).var_1096;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_1095 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  var_1096 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
