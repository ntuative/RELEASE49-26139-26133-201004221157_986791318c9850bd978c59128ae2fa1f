package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_370:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_370)
         {
            var_370 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_370)
            {
               var_370.addEventListener(WindowEvent.const_255,scrollBarEventProc);
               var_370.addEventListener(WindowEvent.const_223,scrollBarEventProc);
            }
         }
         return var_370;
      }
      ...
      override public function dispose() : void
      {
         if(var_370)
         {
            var_370.removeEventListener(WindowEvent.const_255,scrollBarEventProc);
            var_370.removeEventListener(WindowEvent.const_223,scrollBarEventProc);
            var_370 = null;
         }
         if(var_925)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_925)
         {
            var_925 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_925;
      }
