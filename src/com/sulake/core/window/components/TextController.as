package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_545:String = "none";
      
      protected var var_640:Number;
      
      protected var var_377:Number;
      ...
      {
         return new Rectangle(var_640 * maxScrollH,var_377 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_942,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_386,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_386,true));
         ...
         _loc1_.push(new PropertyStruct("margin_left",var_67.left,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_top",var_67.top,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_right",var_67.right,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_67.bottom,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("auto_size",var_545,PropertyStruct.STRING,var_545 != TextFieldAutoSize.NONE));
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_545 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_545 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_545 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_545 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
