package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_504:String = "slider_bar";
      
      private static const const_1134:String = "decrement";
      
      private static const const_800:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_163 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_387;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_504:
      ...
      {
         return findChildByName(ScrollbarController.const_800) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_504) as WindowController;
      }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_52)
         {
            ...
            else if(param2.name == ScrollbarController.const_1134)
            {
               if(var_21)
               {
                  var_636 = true;
            ...
            else if(param2.name == ScrollbarController.const_800)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_504).rectangle;
               if(_horizontal)
               {
