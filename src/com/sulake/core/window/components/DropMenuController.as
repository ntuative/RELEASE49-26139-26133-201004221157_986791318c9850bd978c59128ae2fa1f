package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_127 = context.create(name + "::submenu","",WindowType.const_364,var_79,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_127.include(_loc1_);
         }
         var_127.activate();
         return var_127;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_835)
         {
            if(param2 == var_127)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_449,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_339,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
      ...
      protected function openMenuView() : void
      {
         if(!var_564)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_479,getSubMenu(),subMenuEventProc);
                  var_564 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_439,this,null,true);
         update(this,_loc2_);
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_564 = false;
            getTitleText().text = var_478 < var_479.length && var_478 > -1 ? "null" : caption;
         }
      }
   }
}
