package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_2355:Number = 0;
      
      protected var var_549:Boolean = false;
      
      protected var var_2356:Number = 0;
      
      protected var var_550:Number;
      
      protected var var_1118:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_163 = var_643 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_339,WindowStyle.const_312,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_48,containerEventHandler);
         _container.addEventListener(WindowEvent.const_455,containerEventHandler);
      ...
      {
         return new Rectangle(var_550 * maxScrollH,var_551 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_455,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1033,_spacing,PropertyStruct.const_66,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1035,var_775,PropertyStruct.const_59,var_775 != const_1408));
         _loc1_.push(new PropertyStruct(const_1034,var_549,PropertyStruct.const_59,var_549 != const_1407));
         _loc1_.push(new PropertyStruct(const_1032,var_1118,PropertyStruct.const_59,var_1118 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
