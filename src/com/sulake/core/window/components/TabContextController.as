package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1059:String = "content";
      
      private static const const_1060:String = "selector";
      ...
      protected var var_1614:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1614 == null)
         {
            var_1614 = findChildByTag(TabContextController.const_1059) as IWindowContainer;
         }
         return var_1614;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_951 == null)
         {
            var_951 = findChildByTag(TabContextController.const_1060) as ITabSelectorWindow;
            if(var_951 != null)
            {
      ...
      {
         return !!var_905 ? selector.iterator : null;
      }
