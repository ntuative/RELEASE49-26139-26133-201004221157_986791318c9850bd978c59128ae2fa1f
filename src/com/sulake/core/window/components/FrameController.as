package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_749:String = "margin_top";
      
      private static const const_1038:String = "_HEADER";
      
      private static const const_750:String = "margin_right";
      
      private static const const_1036:String = "_SCALER";
      
      private static const const_1039:String = "_TITLE";
      
      private static const const_1037:String = "_CONTENT";
      
      private static const const_751:String = "margin_left";
      ...
      private var var_1128:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_751,_loc3_.left,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_749,_loc3_.top,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_750,0 - _loc3_.right,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_748,0 - _loc3_.bottom,PropertyStruct.const_66,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_243);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1128 == null)
         {
            var_1128 = findChildByTag(const_1038) as IHeaderWindow;
            if(!var_1128)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1039) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1036) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_264,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1037) as IWindowContainer;
            if(!var_20)
            {
