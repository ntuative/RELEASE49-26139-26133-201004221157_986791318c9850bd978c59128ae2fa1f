package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2294:uint = 0;
      
      protected var var_954:String = "";
      
      protected var var_457:Array;
      
      protected var var_955:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_457 = new Array();
         var_457[0] = MouseCursorType.const_320;
         var_457[1] = MouseCursorType.const_43;
         var_457[2] = MouseCursorType.const_320;
         var_457[3] = MouseCursorType.const_320;
         var_457[4] = MouseCursorType.const_43;
         var_457[5] = MouseCursorType.const_43;
         var_457[6] = MouseCursorType.const_320;
         if(var_332 == null)
         {
            var_332 = new Array();
            var_332[0] = WindowState.const_101;
            var_332[1] = WindowState.const_76;
            var_332[2] = WindowState.const_85;
            var_332[3] = WindowState.const_68;
            var_332[4] = WindowState.WINDOW_STATE_SELECTED;
            var_332[5] = WindowState.const_94;
            var_332[6] = WindowState.const_75;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1030,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_747));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_942,param1.toolTipDelay != const_1406));
         return param2;
      }
