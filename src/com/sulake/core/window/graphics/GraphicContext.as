package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_954:uint = 256;
      
      protected static var var_647:uint = 0;
      
      protected static var var_384:uint = 0;
      
      public static const const_884:uint = 2;
      
      public static const const_1601:uint = 128;
      
      public static const const_1450:uint = 64;
      
      public static const const_679:uint = 4;
      
      public static const const_1286:uint = 0;
      
      public static const const_1373:uint = 16;
      
      public static const const_731:uint = 1;
      
      public static const const_1277:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_644:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1373:
               ...
               break;
            case GraphicContext.const_679:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_954:
               break;
         ...
         if(var_644)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1617,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1617,16777215);
                  }
                  var_384 += bitmap.width * bitmap.height * 4;
               }
