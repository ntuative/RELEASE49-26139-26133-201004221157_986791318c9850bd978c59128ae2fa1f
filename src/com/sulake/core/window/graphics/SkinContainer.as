package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_764:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1777 = new Dictionary();
         TypeCodeTable.fillTables(var_1440,var_1777);
         var_1174 = new Dictionary();
         var_1776 = new Dictionary();
         StateCodeTable.fillTables(var_1174,var_1776);
         var_483 = new Dictionary();
         var_483["skin"] = BitmapSkinRenderer;
         var_483["bitmap"] = BitmapDataRenderer;
         var_483["fill"] = FillSkinRenderer;
         var_483["text"] = TextSkinRenderer;
         var_483["shape"] = ShapeSkinRenderer;
         var_483["unknown"] = SkinRenderer;
         var_483["null"] = NullSkinRenderer;
         if(var_383 == null)
         {
            var_383 = new Array();
            var_383.push(WindowState.const_68);
            var_383.push(WindowState.const_75);
            var_383.push(WindowState.const_94);
            var_383.push(WindowState.WINDOW_STATE_SELECTED);
            var_383.push(WindowState.const_85);
            var_383.push(WindowState.const_76);
            var_383.push(WindowState.const_101);
            var_383.push(WindowState.const_92);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1174)
         {
            _loc3_.push(var_1174[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1440[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_676[param1] = new Array(SkinContainer.const_764);
         }
         var_676[param1][param2] = param3;
         if(true)
         {
            var_675[param1] = new Array(SkinContainer.const_764);
         }
