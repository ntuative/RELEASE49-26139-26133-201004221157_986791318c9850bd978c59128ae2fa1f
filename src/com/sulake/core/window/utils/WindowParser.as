package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1499:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1507:String = "_TEMP";
      ...
      protected var var_1120:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1120,var_1119);
         var_957 = new Dictionary();
         var_1398 = new Dictionary();
         ParamCodeTable.fillTables(var_957,var_1398);
         var_1397 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1120)
            {
               delete var_1120[_loc1_];
            }
            for(_loc1_ in var_1119)
            {
               delete var_1119[_loc1_];
            }
            for(_loc1_ in var_957)
            {
               delete var_957[_loc1_];
            }
