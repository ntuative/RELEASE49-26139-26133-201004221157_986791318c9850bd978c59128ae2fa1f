   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            ...
            var_548 = _loc13_.treshold;
            if(var_643 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_547 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_124,WindowParam.const_146);
         var _loc2_:* = !testParamFlag(WindowParam.const_132,WindowParam.const_140);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
      ...
      {
         var_643 = param1;
         var_547 = !!var_643 ? uint(var_547 | var_1393) : uint(var_547 & 16777215);
      ...
      {
         var_548 = param1 > 255 ? 255 : uint(param1);
      }
      
      public function include(param1:Rectangle) : void
      {
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1946 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_995:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_734:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_79 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_487,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_731,var_8);
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_902);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_341,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_548);
      }
      
      public function set color(param1:uint) : void
      {
         var_1393 = param1 & 4278190080;
         var_547 = !!var_643 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_79);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1026;
                  if(testParamFlag(WindowParam.const_340))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_243))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_167:
                  ...
                  break;
               case WindowNotifyEvent.const_382:
                  var_16.invalidate(this,var_8.union(var_56),WindowRedrawFlag.const_444);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_868,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_245,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_334:
                  ...
                  break;
               case WindowNotifyEvent.const_369:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_907);
                  break;
               case WindowNotifyEvent.const_487:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_426:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_444);
                     }
                  }
                  else if(_param & 0)
                  {
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_548);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_734,this,param1));
         return param1;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_597,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_68,true);
         _loc1_.type = WindowNotifyEvent.const_1257;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_163 && var_548 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1478,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1478,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1236,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_68,false);
         _loc1_.type = WindowNotifyEvent.const_1315;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               ...
               var_56.width = var_8.width;
               var_56.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_462,this,var_9));
            }
            else
            {
               var_302.x = 0;
               ...
               var_302.width = 0;
               var_302.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_995,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,_param,var_16,var_8,null,var_641,properties,var_642.concat(),_id) as WindowController;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_551;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_393;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_32 == WindowState.const_466)
         {
            return true;
         }
         var_32 = WindowState.const_466;
