package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected var var_393:uint = 0;
      
      protected var var_16:IContext = null;
      
      protected var var_2194:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_949 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_949);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1121 & const_967)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_393 + "]";
      }
   }
}
