package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1054:uint = 1;
      
      private static const const_493:uint = 0;
      
      private static const const_769:uint = 2;
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         var array:Array = var_259[event.type];
         if(array)
         {
            callbacks = [];
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1054) : uint(const_493);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_259)
            {
               _loc2_ = var_259[_loc1_] as Array;
               for each(_loc3_ in _loc2_)
               {
                  _loc3_.callback = null;
               }
               delete var_259[_loc1_];
            }
            var_259 = null;
