package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      {
         if(var_409 != param1 * var_1480)
         {
            var_409 = param1 * var_1480;
            ++var_76;
         }
      }
      ...
      {
         if(var_408 != param1 * var_1481)
         {
            var_408 = param1 * var_1481;
            ++var_76;
         }
      }
      ...
      {
         if(var_407 != param1 * var_1479)
         {
            var_407 = param1 * var_1479;
            ++var_76;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1016.assign(_loc22_);
         }
         else
         {
            var_1016.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_407;
         _loc2_.z *= var_409;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1016);
         if(_loc3_ < var_2361 || _loc3_ > var_2362)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_407;
            _loc2_.z *= var_409;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1016);
         }
      ...
      {
         return new Vector3d(0 * var_408,0 * var_407,0 * var_409);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_408,0 * var_407,0 * var_409);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_80;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_408,param2.y * var_407,param2.z * var_409);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_408,param3.y * var_407,param3.z * var_409);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_408,param4.y * var_407,param4.z * var_409);
