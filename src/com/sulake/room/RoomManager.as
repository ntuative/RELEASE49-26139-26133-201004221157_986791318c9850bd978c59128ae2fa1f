package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_814:XML = null;
      
      private var var_32:int = 0;
      
      private var var_110:IRoomManagerListener;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         _events.addEventListener(RoomContentLoadedEvent.const_435,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_649,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_32 == const_1285)
         {
            if(var_814 != null)
            {
               return false;
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_110 != null)
            {
               var_110.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_110 != null)
            {
               var_110.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_110 != null)
         {
            var_110.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_43.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_489.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_489.splice(_loc2_,1);
            }
            if(false)
            {
               ...
               if(var_110 != null)
               {
                  var_110.roomManagerInitialized();
               }
            }
         }
         else
         {
            var_32 = const_592;
            var_110.roomManagerInitialized(false);
         }
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 if(var_110 != null)
                                 {
                                    var_110.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
