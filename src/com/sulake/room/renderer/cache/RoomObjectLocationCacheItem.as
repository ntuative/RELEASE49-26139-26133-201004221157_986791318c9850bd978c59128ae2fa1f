package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         if(param1 != var_1307 || param2 != var_1764)
         {
            var_1307 = param1;
            var_1764 = param2;
            return true;
         ...
         if(param3)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     var_255 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     var_255.assign(_loc5_);
                  }
               }
               else
               {
            ...
            var_255.x = Math.round(var_255.x);
            var_255.y = Math.round(var_255.y);
         }
         return var_255;
      }
