package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_799:int = 50;
      ...
      private var var_2255:Number = -10000000;
      
      private var var_2256:Number = -10000000;
      ...
      private var var_1105:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_245 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
      ...
      public function update() : void
      {
         if(var_1103 == 0)
         {
            checkMouseHits(var_1104.x,var_1104.y,MouseEvent.MOUSE_MOVE);
         }
         var_1103 = 0;
         ++var_1606;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_288 != null)
         {
            var_288.graphics.clear();
         }
         else
         {
            var_288 = new Sprite();
            var_288.name = "mask";
            _master.addChild(var_288);
         }
         var_288.graphics.beginFill(0);
         var_288.graphics.drawRect(0,0,param1,param2);
         var_771 = param1;
         var_772 = param2;
         var_55.graphics.clear();
         var_55.graphics.beginFill(var_2369);
      ...
      {
         var _loc11_:Number = param1 - var_771 / 2;
         var _loc12_:Number = param2 - var_772 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_771 != var_2254 || var_772 != var_2257)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_452.sortOn("z",0 | 0);
         if(_loc6_ < var_452.length)
         {
            var_452.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_452[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_938.push(_loc12_ - _loc2_);
         if(var_938.length == const_799)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_799)
            {
               _loc13_ += var_938[_loc14_];
               _loc14_++;
            }
            var_938 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_543.length)
            {
               cleanSprite(var_543[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_543 = [];
         }
         ...
         while(_loc1_ < var_325.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1105 != null)
                  {
                     var_1105.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1606,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_245.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_245.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_452.length)
         {
            return null;
         }
         return var_452[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2255 || param2 != var_2256)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_543.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_245.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_245.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_245.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_245.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         var _loc6_:RoomObjectCacheItem = var_542.getObjectCache(param2);
         ...
         _loc12_ += int(var_771 / 2);
         _loc13_ += int(var_772 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_771 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_772))
                  {
